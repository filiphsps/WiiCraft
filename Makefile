...
#---------------------------------------------------------------------------------
LIBS	:= -lfat -lGEMS_wifiWii -logc -lm -lgrrlib -lfreetype -lfat -ljpeg -lpngu -lpng -lz -lasnd -lmad -fpermissive -lwiiuse -lbte -logc -lm -lsmpeg -lfat -lwiiuse -lbte -lwiikeyboard -logc
